...
A python program that generates a list of customers within a given distance of the office
# Usage
...
$ cd intercom
$ pipenv shell
$ python src/main.py --distance 50
```

  * The --distance flag specifies the distance in km from the office defaults to 100km if not specified
  * The --debug enables debug level logs

### Running tests
```sh
$ cd intercom
$ pipenv shell
$ python -m pytest src/ test/ -vv
```
...
$ pipenv shell
$ python src/main.py
Customer ID - 4 Customer Name - Ian Kehoe
Customer ID - 5 Customer Name - Nora Dempsey
Customer ID - 6 Customer Name - Theresa Enright
Customer ID - 8 Customer Name - Eoin Ahearn
Customer ID - 11 Customer Name - Richard Finnegan
Customer ID - 12 Customer Name - Christina McArdle
Customer ID - 13 Customer Name - Olive Ahearn
Customer ID - 15 Customer Name - Michael Ahearn
Customer ID - 17 Customer Name - Patricia Cahill
Customer ID - 23 Customer Name - Eoin Gallagher
Customer ID - 24 Customer Name - Rose Enright
Customer ID - 26 Customer Name - Stephen McArdle
Customer ID - 29 Customer Name - Oliver Ahearn
Customer ID - 30 Customer Name - Nick Enright
Customer ID - 31 Customer Name - Alan Behan
Customer ID - 39 Customer Name - Lisa Ahearn
```
...
Sample Input File for outputs above
